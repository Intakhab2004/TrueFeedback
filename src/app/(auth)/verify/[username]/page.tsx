...
const CodeVerification = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-[linear-gradient(354deg,rgba(0,0,0,1)_0%,rgba(25,25,60,1)_30%,rgba(10,40,60,1)_100%)]">
